...
namespace QX.DataAceess
{
   ...
   public partial class ADOSys_PD_Module
   {
      ...
      public int Add(Sys_PD_Module sys_PD_Module)
      {
         ...
         {
            idb.AddParameter("@SPM_LX", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@SPM_LY", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@SPM_TX", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@SPM_TY", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@SPM_LI", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@SPM_TI", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@SPM_CNum", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@SPM_Height", DBNull.Value);
         }
         else
         {
