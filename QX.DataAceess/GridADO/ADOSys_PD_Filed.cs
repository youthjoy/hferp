...
namespace QX.DataAceess
{
   ...
   public partial class ADOSys_PD_Filed
   {
      ...
      {
         string sql = "INSERT INTO Sys_PD_Filed (DCP_ModuleName,DCP_ControlID,DCP_Label,DCP_ControlType,DCP_Type,DCP_Style,DCP_Order,DCP_IsHidden,DCP_IsReadonly,DCP_UDef1,DCP_UDef2,DCP_PageName,DCP_CreateTime,DCP_Model,Stat,DCP_RefSQL,DCP_RefBack,DCP_RefValue,DCP_RefCode,DCP_TX,DCP_TY,DCP_TI,DCP_Height,DCP_PControl,DCP_CControl) VALUES (@DCP_ModuleName,@DCP_ControlID,@DCP_Label,@DCP_ControlType,@DCP_Type,@DCP_Style,@DCP_Order,@DCP_IsHidden,@DCP_IsReadonly,@DCP_UDef1,@DCP_UDef2,@DCP_PageName,@DCP_CreateTime,@DCP_Model,@Stat,@DCP_RefSQL,@DCP_RefBack,@DCP_RefValue,@DCP_RefCode,@DCP_TX,@DCP_TY,@DCP_TI,@DCP_Height,@DCP_PControl,@DCP_CControl)";
         ...
         {
            idb.AddParameter("@DCP_Order", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@DCP_IsHidden", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@DCP_IsReadonly", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@DCP_TX", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@DCP_TY", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@DCP_TI", DBNull.Value);
         }
         else
         {
         ...
         {
            idb.AddParameter("@DCP_Height", DBNull.Value);
         }
         else
         {
      ...
      {
         string sql = "INSERT INTO Sys_PD_Filed (DCP_ModuleName,DCP_ControlID,DCP_Label,DCP_ControlType,DCP_Type,DCP_Style,DCP_Order,DCP_IsHidden,DCP_IsReadonly,DCP_UDef1,DCP_UDef2,DCP_PageName,DCP_CreateTime,DCP_Model,Stat,DCP_RefSQL,DCP_RefBack,DCP_RefValue,DCP_RefCode,DCP_TX,DCP_TY,DCP_TI,DCP_Height,DCP_PControl,DCP_CControl) VALUES (@DCP_ModuleName,@DCP_ControlID,@DCP_Label,@DCP_ControlType,@DCP_Type,@DCP_Style,@DCP_Order,@DCP_IsHidden,@DCP_IsReadonly,@DCP_UDef1,@DCP_UDef2,@DCP_PageName,@DCP_CreateTime,@DCP_Model,@Stat,@DCP_RefSQL,@DCP_RefBack,@DCP_RefValue,@DCP_RefCode,@DCP_TX,@DCP_TY,@DCP_TI,@DCP_Height,@DCP_PControl,@DCP_CControl);SELECT @@IDENTITY AS ReturnID;";
         if (string.IsNullOrEmpty(sys_PD_Filed.DCP_ModuleName))
         {
            idb.AddParameter("@DCP_ModuleName", DBNull.Value);
         }
      ...
      public Sys_PD_Filed GetByKey(decimal dCP_ID)
      {
         ...
         string sql = "SELECT  DCP_ID,DCP_ModuleName,DCP_ControlID,DCP_Label,DCP_ControlType,DCP_Type,DCP_Style,DCP_Order,DCP_IsHidden,DCP_IsReadonly,DCP_UDef1,DCP_UDef2,DCP_PageName,DCP_CreateTime,DCP_Model,Stat,DCP_RefSQL,DCP_RefBack,DCP_RefValue,DCP_RefCode,DCP_TX,DCP_TY,DCP_TI,DCP_Height,DCP_PControl,DCP_CControl FROM Sys_PD_Filed WHERE 1=1 AND ((Stat is null) or (Stat=0) )  AND DCP_ID=@DCP_ID ";
         idb.AddParameter("@DCP_ID", dCP_ID);
      ...
      public List<Sys_PD_Filed> GetListByWhere(string strCondition)
      {
         ...
         string sql = "SELECT  DCP_ID,DCP_ModuleName,DCP_ControlID,DCP_Label,DCP_ControlType,DCP_Type,DCP_Style,DCP_Order,DCP_IsHidden,DCP_IsReadonly,DCP_UDef1,DCP_UDef2,DCP_PageName,DCP_CreateTime,DCP_Model,Stat,DCP_RefSQL,DCP_RefBack,DCP_RefValue,DCP_RefCode,DCP_TX,DCP_TY,DCP_TI,DCP_Height,DCP_PControl,DCP_CControl FROM Sys_PD_Filed WHERE 1=1 AND ((Stat is null) or (Stat=0) ) ";
