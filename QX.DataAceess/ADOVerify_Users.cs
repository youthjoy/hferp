...
namespace QX.DataAceess
{
   ...
   public partial class ADOVerify_Users
   {
      ...
      {
         string sql = "INSERT INTO Verify_Users (VU_VerifyNode_Code,VU_User,VU_UserName,VU_DeptName,VU_Dept,VU_Duty,VU_VerifyTempldate_Code,Stat) VALUES (@VU_VerifyNode_Code,@VU_User,@VU_UserName,@VU_DeptName,@VU_Dept,@VU_Duty,@VU_VerifyTempldate_Code,@Stat)";
      ...
      {
         string sql = "INSERT INTO Verify_Users (VU_VerifyNode_Code,VU_User,VU_UserName,VU_DeptName,VU_Dept,VU_Duty,VU_VerifyTempldate_Code,Stat) VALUES (@VU_VerifyNode_Code,@VU_User,@VU_UserName,@VU_DeptName,@VU_Dept,@VU_Duty,@VU_VerifyTempldate_Code,@Stat);SELECT @@IDENTITY AS ReturnID;";
         if (string.IsNullOrEmpty(verify_Users.VU_VerifyNode_Code))
         {
            idb.AddParameter("@VU_VerifyNode_Code", DBNull.Value);
         }
      ...
      public Verify_Users GetByKey(decimal vU_ID)
      {
         ...
         string sql = "SELECT  VU_ID,VU_VerifyNode_Code,VU_User,VU_UserName,VU_DeptName,VU_Dept,VU_Duty,VU_VerifyTempldate_Code,Stat FROM Verify_Users WHERE 1=1 AND ((Stat is null) or (Stat=0) )  AND VU_ID=@VU_ID ";
         idb.AddParameter("@VU_ID", vU_ID);
      ...
      public List<Verify_Users> GetListByWhere(string strCondition)
      {
         ...
         string sql = "SELECT  VU_ID,VU_VerifyNode_Code,VU_User,VU_UserName,VU_DeptName,VU_Dept,VU_Duty,VU_VerifyTempldate_Code,Stat FROM Verify_Users WHERE 1=1 AND ((Stat is null) or (Stat=0) ) ";
