...
namespace QX.DataAceess
{
   ...
   public partial class ADOVerify_TemplateConfig
   {
      ...
      {
         string sql = "INSERT INTO Verify_TemplateConfig (VT_Template_Code,VT_Key,VT_VerifyNode_Code,VT_VerifyNode_Name,Flag,VT_VerifyNode_Order,VT_VerifyNode_Back,VT_VerifyNode_BackName,Stat,VT_AcSum,VT_AcNodeName,VT_AcNodeCode,VT_Remark) VALUES (@VT_Template_Code,@VT_Key,@VT_VerifyNode_Code,@VT_VerifyNode_Name,@Flag,@VT_VerifyNode_Order,@VT_VerifyNode_Back,@VT_VerifyNode_BackName,@Stat,@VT_AcSum,@VT_AcNodeName,@VT_AcNodeCode,@VT_Remark)";
      ...
      {
         string sql = "INSERT INTO Verify_TemplateConfig (VT_Template_Code,VT_Key,VT_VerifyNode_Code,VT_VerifyNode_Name,Flag,VT_VerifyNode_Order,VT_VerifyNode_Back,VT_VerifyNode_BackName,Stat,VT_AcSum,VT_AcNodeName,VT_AcNodeCode,VT_Remark) VALUES (@VT_Template_Code,@VT_Key,@VT_VerifyNode_Code,@VT_VerifyNode_Name,@Flag,@VT_VerifyNode_Order,@VT_VerifyNode_Back,@VT_VerifyNode_BackName,@Stat,@VT_AcSum,@VT_AcNodeName,@VT_AcNodeCode,@VT_Remark);SELECT @@IDENTITY AS ReturnID;";
         if (string.IsNullOrEmpty(verify_TemplateConfig.VT_Template_Code))
         {
            idb.AddParameter("@VT_Template_Code", DBNull.Value);
         }
      ...
      public Verify_TemplateConfig GetByKey(decimal vT_ID)
      {
         ...
         string sql = "SELECT  VT_ID,VT_Template_Code,VT_Key,VT_VerifyNode_Code,VT_VerifyNode_Name,Flag,VT_VerifyNode_Order,VT_VerifyNode_Back,VT_VerifyNode_BackName,Stat,VT_AcSum,VT_AcNodeName,VT_AcNodeCode,VT_Remark FROM Verify_TemplateConfig WHERE 1=1 AND ((Stat is null) or (Stat=0) )  AND VT_ID=@VT_ID ";
         idb.AddParameter("@VT_ID", vT_ID);
      ...
      public List<Verify_TemplateConfig> GetListByWhere(string strCondition)
      {
         ...
         string sql = "SELECT  VT_ID,VT_Template_Code,VT_Key,VT_VerifyNode_Code,VT_VerifyNode_Name,Flag,VT_VerifyNode_Order,VT_VerifyNode_Back,VT_VerifyNode_BackName,Stat,VT_AcSum,VT_AcNodeName,VT_AcNodeCode,VT_Remark FROM Verify_TemplateConfig WHERE 1=1 AND ((Stat is null) or (Stat=0) ) ";
