...
namespace QX.DataAceess
{
   ...
   public partial class ADOSys_UserPermission
   {
      ...
      {
         string sql = "INSERT INTO Sys_UserPermission (PU_Code,PU_FunCode,PU_FunName,PU_FunPCode,PU_UserName,PU_UserCode,Stat) VALUES (@PU_Code,@PU_FunCode,@PU_FunName,@PU_FunPCode,@PU_UserName,@PU_UserCode,@Stat)";
         ...
         if (string.IsNullOrEmpty(sys_UserPermission.PU_UserName))
         {
            idb.AddParameter("@PU_UserName", DBNull.Value);
         }
         else
         {
            idb.AddParameter("@PU_UserName", sys_UserPermission.PU_UserName);
         }
      ...
      {
         string sql = "INSERT INTO Sys_UserPermission (PU_Code,PU_FunCode,PU_FunName,PU_FunPCode,PU_UserName,PU_UserCode,Stat) VALUES (@PU_Code,@PU_FunCode,@PU_FunName,@PU_FunPCode,@PU_UserName,@PU_UserCode,@Stat);SELECT @@IDENTITY AS ReturnID;";
         if (string.IsNullOrEmpty(sys_UserPermission.PU_Code))
         {
            idb.AddParameter("@PU_Code", DBNull.Value);
         }
      ...
      if(sys_UserPermission.PU_UserName_IsChanged){sbParameter.Append("PU_UserName=@PU_UserName, ");}
      ...
      string sql=sb.ToString();
         ...
         if(sys_UserPermission.PU_UserName_IsChanged)
         {
         if (string.IsNullOrEmpty(sys_UserPermission.PU_UserName))
         {
            idb.AddParameter("@PU_UserName", DBNull.Value);
      ...
      public Sys_UserPermission GetByKey(decimal pU_ID)
      {
         ...
         string sql = "SELECT  PU_ID,PU_Code,PU_FunCode,PU_FunName,PU_FunPCode,PU_UserName,PU_UserCode,Stat FROM Sys_UserPermission WHERE 1=1 AND ((Stat is null) or (Stat=0) )  AND PU_ID=@PU_ID ";
         idb.AddParameter("@PU_ID", pU_ID);
         ...
         while(dr.Read())
         {
            ...
            if (dr["PU_UserName"] != DBNull.Value) sys_UserPermission.PU_UserName = Convert.ToString(dr["PU_UserName"]);
      ...
      public List<Sys_UserPermission> GetListByWhere(string strCondition)
      {
         ...
         string sql = "SELECT  PU_ID,PU_Code,PU_FunCode,PU_FunName,PU_FunPCode,PU_UserName,PU_UserCode,Stat FROM Sys_UserPermission WHERE 1=1 AND ((Stat is null) or (Stat=0) ) ";
