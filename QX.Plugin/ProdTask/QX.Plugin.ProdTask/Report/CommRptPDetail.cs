...
{
    public partial class CommRptPDetail : F_BasciForm
    {
        public CommRptPDetail()
        {
            InitializeComponent();
        }
        ...
        public CommRptPDetail(string data)
        {
            InitializeComponent();
        ...
        void NodeViewBtn_Click(object sender, EventArgs e)
        {
            ...
            if (row != null)
            {
                string pcode = row.Cells["PlanProd_PlanCode"].Value.ToString();
