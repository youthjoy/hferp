...
{
    public class CommTrash : IPlugin
    {
        ...
        public void Load()
        {
            CommTrashList contract = new CommTrashList(data);
    ...
    public class CommOnTrashList : IPlugin
    {
        ...
        public void Load()
        {
            CommOnTrash contract = new CommOnTrash(data);
            contract.MdiParent = this.application as Form;
            contract.Show();
        }
