...
{
    public partial class FHelperOp : F_BasicPop
    {
        ...
        public FHelperOp(Bll_FHelper_Info _instance, FHelper_Info _gmodel, string _iType, bool _isAudit)
        {
            InitializeComponent();
        ...
        public FHelperOp(Bll_FHelper_Info _instance, FHelper_Info _gmodel)
        {
            InitializeComponent();
        ...
        public bool SaveData()
        {
            ...
            flag=MainInstance.Update(GModel);
