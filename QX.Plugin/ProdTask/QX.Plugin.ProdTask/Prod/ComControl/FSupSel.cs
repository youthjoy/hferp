...
{
    public partial class FSupSel : Form
    {
        public FSupSel(string partno)
        {
            InitializeComponent();
        ...
        public delegate void DCallBackHandler(object sender, List<FHelper_Price> list);
        ...
        public void BindEvent()
        {
            ...
            if (PartNo != null)
            {
                ...
                this.tool_bar.toolStrip1.Items["Key"].Text = PartNo;
            }
        }
        ...
        void tool_bar_SearchClicked(object sender, EventArgs e)
        {
            ...
            var list = ppInstance.GetFHelperPriceListForSearch(bDate, eDate, key);
        ...
        void tool_bar_SaveClicked(object sender, EventArgs e)
        {
            ...
            {
                FHelper_Price road = r.ListObject as FHelper_Price;
                list.Add(road);
            }
