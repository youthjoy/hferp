...
namespace QX.Common.C_Class
{
    public  class InIHepler
    {
                                ...
                                string defaultValue)
        {
            ...
            StringBuilder retval = new StringBuilder(InIHepler.MaxSectionSize);

            NativeMethods.GetPrivateProfileString(sectionName,
                                                  keyName,
                                                  defaultValue,
                                                  retval,
                                                  InIHepler.MaxSectionSize,
                                                  m_path);
        ...
        public List<KeyValuePair<string, string>> GetSectionValuesAsList(string sectionName)
        {
            ...
            IntPtr ptr = Marshal.AllocCoTaskMem(InIHepler.MaxSectionSize);
        ...
        public string[] GetSectionNames()
        {
            ...
            try
            {
                ...
                len = NativeMethods.GetPrivateProfileSectionNames(ptr,
                    InIHepler.MaxSectionSize, m_path);
